...
function getNewFlag(){
  ...
  nameImagePng1 = arrayNameImageFlag[getNumberRandom()];

  nameImagePng2 = arrayNameImageFlag[getNumberRandom()];

  nameImagePng3 = arrayNameImageFlag[getNumberRandom()];

  nameImagePng4 = arrayNameImageFlag[getNumberRandom()];

  elementoImageHtml1.src = '../flags/' + nameImagePng1;
  elementoImageHtml2.src = '../flags/' + nameImagePng2;
  elementoImageHtml3.src = '../flags/' + nameImagePng3;
  elementoImageHtml4.src = '../flags/' + nameImagePng4;
}
...
function getNumberRandom() {
  return Math.floor(Math.random() * arrayNameImageFlag.length);
}